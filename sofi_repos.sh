...
git clone git@gitlab.com:sofiinc/money/money-partner-services/money-partner-consumers.git
git clone git@gitlab.com:sofiinc/money/money-transactions.git
git clone git@gitlab.com:sofiinc/money/money-accounts.git
git clone git@gitlab.com:sofiinc/money/money-ui.git
git clone git@gitlab.com:sofiinc/money/banking.git
git clone git@gitlab.com:sofiinc/money/money-snapshot.git
